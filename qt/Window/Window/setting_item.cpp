...
void SettingItem::createGraphPage()
{
    ...
    layout_coo->addWidget(new QPushButton(tr("open file"), section[1]));
    ...
    layout_axi[0]->addWidget(new QLabel("graduation", section[2]),3,0);
    layout_axi[0]->addWidget(new QDoubleSpinBox(section[2]),0,1);
    layout_axi[0]->addWidget(new QDoubleSpinBox(section[2]),1,1);
    layout_axi[0]->addWidget(new QDoubleSpinBox(section[2]),2,1);
    layout_axi[0]->addWidget(new QDoubleSpinBox(section[2]),3,1);
    ...
    layout_axi[1]->addWidget(new QLabel("graduation", section[3]),3,0);
    layout_axi[1]->addWidget(new QDoubleSpinBox(section[3]),0,1);
    layout_axi[1]->addWidget(new QDoubleSpinBox(section[3]),1,1);
    layout_axi[1]->addWidget(new QDoubleSpinBox(section[3]),2,1);
    layout_axi[1]->addWidget(new QDoubleSpinBox(section[3]),3,1);

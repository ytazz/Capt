...
void OriginalSignalSlot::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<OriginalSignalSlot *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (OriginalSignalSlot::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OriginalSignalSlot::textLengthChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject OriginalSignalSlot::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_OriginalSignalSlot.data,
    qt_meta_data_OriginalSignalSlot,
    qt_static_metacall,
    nullptr,
    nullptr
} };

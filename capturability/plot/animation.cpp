...
int main() {
  ...
  state.swf.setPolar(0.11, 90 * 3.14159 / 180);
  // state.icp.setCartesian(0.073724, 0.051622);
  // state.swf.setCartesian(0.001018, 0.109979);
  ...
  // cr_plot.setInput("Basin.csv", DataType::BASIN);
  // cr_plot.setInput("Nstep.csv", DataType::NSTEP);

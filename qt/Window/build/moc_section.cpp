...
const QMetaObject Section::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Section.data,
      qt_meta_data_Section,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Section::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Section.stringdata0))
        return static_cast<void*>(const_cast< Section*>(this));
